...
async def index_project(request: Request, project_id: int, push_request: PushRequest):
    ...
    print(type(push_request))
    print(push_request.model_dump())
    print(push_request.__class__)
    ...
    while has_records:
        ...
        if not is_inserted:
            return JSONResponse(
                ...
                content={"signal": ResponseSignal.INSERT_INTO_VECTORDB_FAILED.value},
            )
...
async def get_project_index_info(request: Request, project_id: int):
    ...
    return JSONResponse(content=jsonable_encoder(collection_info))
